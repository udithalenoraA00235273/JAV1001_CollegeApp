...
public class HeDentalHygiene extends AppCompatActivity {
    ...
    public void ApplyNow(){
        ...
        applyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent guest = new Intent(HeDentalHygiene.this, LoginScreen.class);
                startActivity(guest);
            }
        });
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.he_dental_hygiene);
        ApplyNow();
    }
}